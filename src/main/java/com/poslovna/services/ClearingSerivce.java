...
public interface ClearingSerivce {
	void processClearing(ClearingCreation clearing) throws NelikvidanException, PojedinacnoPlacanjeException, NepostojeciRacunException, NepostojecaBankaException;
}
